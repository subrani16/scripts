...
This script processes Encord annotation files within a specified directory and filters objects based on
minimum pixel size requirements. The annotation format accepted:
...
```bash
python filter_annotations.py -d <input_director/annotation_file> -o <output_directory>
```

The script will output a new directory called "<annotation file name>" in the same `-o` location specified. 
